...
export default function Portfolio() {
  ...
  const categoryMap: Record<string, string> = {
    ...
    Sports: t.portfolio.categories.sports,
    Logistics: t.portfolio.categories.logistics,
    Casino: t.portfolio.categories.casino,
    Ecommerce: t.portfolio.categories.ecommerce,
    SaaS: t.portfolio.categories.saas,
    Music: t.portfolio.categories.music,
    Restaurant: t.portfolio.categories.restaurant,
  }
